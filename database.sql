...
INSERT INTO users (username, email, password, role, display_name, bio, avatar) VALUES
('admin', 'admin@blog.com', '$2y$12$3nJkYG./dT/4MuNsSNTA2OzrDISljXQFpbktiL5zIhsDRDQAEwdgS', 'admin', 'Alex Morgan', 'Diseñador UI/UX y desarrollador full-stack con más de 10 años de experiencia creando experiencias web únicas.', 'avatar_alex.png')
...
(3, 'Sofía Castro', 'sofia@work.com', 'La automatización de flujos de trabajo me ha salvado la vida en mi agencia de marketing. Gran recomendación.', 'approved')
ON DUPLICATE KEY UPDATE id=id;
...
('Sobre el Autor', 'sobre-el-autor', '<h2>Bienvenidos a ModernBlog</h2><p>ModernBlog es un espacio técnico fundado y administrado por <strong>Alex Morgan</strong>. Nuestro propósito es ofrecer a la comunidad de desarrolladores y diseñadores tutoriales prácticos de alta calidad, consejos de arquitectura frontend y backend, y novedades en el mundo de la tecnología.</p><h2>Nuestra Misión</h2><p>Buscamos simplificar conceptos complejos y promover el uso de tecnologías nativas y eficientes para la construcción de una web más accesible, rápida y estéticamente premium.</p><p>Si deseas colaborar o compartir tus artículos, ponte en contacto con nosotros.</p>'),
