    ...
    <div class="lg:col-span-2 glass-card rounded-3xl p-8 border border-slate-200/50 dark:border-slate-800/80 shadow-md">
        <form action="/?route=admin/settings" method="POST" class="space-y-8">
            ...
            <div class="space-y-4 pt-2">
                ...
                <p class="text-xs text-slate-400"><strong>Opcional (SEO Local):</strong> Configura la ubicación geográfica solo si tu sitio corresponde a un negocio físico o local. Si tu blog es global, puedes dejar estos campos completamente en blanco para no restringir su alcance.</p>
