...
('theme_light_primary', '#7c3aed'),
('theme_light_secondary', '#4f46e5'),
('theme_dark_primary', '#a78bfa'),
('theme_dark_secondary', '#6366f1'),
('theme_light_bg', '#f8fafc'),
('theme_dark_bg', '#020617'),
('theme_light_header', '#ffffff'),
('theme_dark_header', '#020617'),
('theme_light_footer', '#ffffff'),
('theme_dark_footer', '#0f172a'),
